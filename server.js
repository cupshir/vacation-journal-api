...
app.get(apiRoot + '/person/all', PersonController.get);
...
app.get(apiRoot + '/park/all', ParkController.get);
...
app.get(apiRoot + '/attraction/all', AttractionController.get);
...
app.get(apiRoot + '/journal/all', JournalController.get);
...
app.get(apiRoot + '/journal-entry/all', JournalEntryController.get);
